...
public class APIWorkflowSteps {
    ...
    @Then("the retrieved data at {string} object matches the data use to create the employee having employee id {string}")
    public void the_retrieved_data_at_object_matches_the_data_use_to_create_the_employee_having_employee_id(String empObj, String resEmpID, DataTable dataTable) {
    ...
    public void aRequestIsPreparedToCreateAnEmployeeViaDynamicPayload(String firstName, String lastName, String middleName, String gender,
